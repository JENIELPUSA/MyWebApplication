...
router
  .route("/updateDataAssignTechnician/:RequestId")
  .patch(authController.protect, MaintenanceRoute.updateDataAssignTechnician);

router
  .route("/MaintenanceTask")
  .get(authController.protect, MaintenanceRoute.TechnicianTask);
