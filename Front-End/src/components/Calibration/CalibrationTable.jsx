  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 font-['Poppins']">
      ...
      <motion.div
        ...
        className={`relative w-full max-w-4xl h-[85vh] bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-300 flex flex-col font-['Poppins'] ${isFormModalOpen ? "blur-sm grayscale-[0.5]" : ""}`}
      >
        {/* Header */}
        <div className="bg-[#1e3a8a] px-6 py-4 text-white flex justify-between items-center flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-black uppercase tracking-tight font-['Poppins']">Laptop <span className="text-yellow-400">Technical Audit</span></h2>
              <p className="text-[9px] text-blue-200 uppercase font-bold tracking-[0.2em] font-['Poppins']">Display & Hardware Verification</p>
            </div>
          </div>
        ...
        {/* Device Snapshot Bar */}
        <div className="bg-slate-50 border-b border-slate-200 px-8 py-3 flex justify-between items-center text-[11px] flex-shrink-0 font-['Poppins']">
          ...
          <div className="flex items-center gap-2 text-slate-500 font-bold uppercase font-['Poppins']">
          ...
          <div className="flex-grow overflow-y-auto rounded-2xl border border-slate-200 shadow-inner bg-white custom-scrollbar">
            <table className="w-full text-left border-collapse">
              <thead className="sticky top-0 z-10">
                <tr className="bg-slate-800 text-white text-[10px] uppercase tracking-widest font-['Poppins']">
                  ...
                  <th className="p-4 text-center">
                    {role === "User" && (
                      <button onClick={() => setFormModalOpen(true)} className="bg-yellow-400 text-blue-900 p-2 rounded-lg hover:scale-110 shadow-sm font-['Poppins']">
                        <FaPlus size={12} />
                      </button>
                    )}
                  </th>
              ...
              <tbody className="text-[12px] font-bold text-slate-600 font-['Poppins']">
                {loading ? (
                  ...
                  calibrations.map((data) => (
                    <tr key={data._id} className="border-b border-slate-100 hover:bg-blue-50/40 transition-colors group">
                      <td className="p-4 pl-6 font-normal text-slate-400 italic font-['Poppins']">{formatDateTime(data.CalibrationDate)}</td>
                      ...
                      <td className="p-4 text-center font-['Poppins']">
                        <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[9px] font-black border font-['Poppins'] ${
        ...
        <div className="bg-yellow-400 py-2 text-center border-t border-yellow-500 flex-shrink-0">
          <p className="text-[8px] font-black text-blue-900 uppercase tracking-[0.5em] font-['Poppins']">Device Integrity Protocol • Lab Verified Log</p>
        </div>
      </motion.div>
