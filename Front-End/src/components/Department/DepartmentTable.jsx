...
const DepartmentTable = ({
    ...
    currentPage,
    totalDepartment,
    setDepartmentPerPage // This was missing in your code
}) => {
                ...
                <div className="flex-col text-gray-700 bg-white shadow-md rounded-xl bg-clip-border px-4 py-4">
                    <div className="overflow-y-auto" style={{ maxHeight: '400px' }}>
                        <table className="w-full text-left table-auto border-collapse">
                            <thead>
                                <tr>
                                    <th className="p-4 border-b border-gray-300 bg-blue-50 text-gray-700">Category Name</th>
                            ...
                            <tbody>
                                {isNoDepartment ? (
                                    ...
                                    filteredEquipment.map((department) => (
                                        <tr key={department._id} className="hover:bg-gray-100 transition-colors">
                    ...
                    <div className="flex space-x-1 justify-center mt-4">
                        ...
                        <button
                            className={`rounded-full border border-slate-300 py-2 px-3 text-center text-sm transition-all shadow-sm text-slate-600 hover:text-white hover:bg-gradient-to-r from-blue-500 to-indigo-500 ${currentPage === totalPages || isNoDepartment ? 'opacity-50 cursor-not-allowed' : ''}`}
                            onClick={() => paginate(currentPage + 1)}
