...
import axiosInstance from "../../components/ReusableComponent/SuccessandFailedModal";
...
export const NotificationProvider = ({ children }) => {
    ...
    return (
        <NotificationContext.Provider value={{ setToAdmin, setToTechnician, triggerSendEmail }}>
            {children}
